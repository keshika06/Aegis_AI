          ...
          <ResponsiveContainer width="100%" height={300}>
            <ScatterChart margin={{ top: 10, right: 20, bottom: 20, left: -10 }}>
              ...
              <XAxis
                ...
                tick={{ fill: '#7c8aab', fontSize: 11 }} axisLine={{ stroke: '#232b3d' }}
                label={{ value: 'Likelihood →', position: 'insideBottom', offset: -10, fill: '#7c8aab', fontSize: 11 }}
              />
              <YAxis
                type="number" dataKey="impact" name="Impact" domain={[0, 10]}
                tick={{ fill: '#7c8aab', fontSize: 11 }} axisLine={{ stroke: '#232b3d' }}
                label={{ value: 'Impact →', angle: -90, position: 'insideLeft', fill: '#7c8aab', fontSize: 11 }}
              />
              <ZAxis type="number" dataKey="z" range={[60, 300]} />
              <ReferenceLine x={5} stroke="#2a3348" strokeDasharray="3 3" />
              <ReferenceLine y={5} stroke="#2a3348" strokeDasharray="3 3" />
              <Tooltip
